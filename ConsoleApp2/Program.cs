...
namespace ConsoleApp2
{
    ...
    class Program
    {
        ...
        public class Options
        {
            ...
            [Option('b', "baud", Required = false, HelpText = "Baud rate (115200 for example)")]
            public int Baud { get; set; }
            [Option('m', "mode", Required = false, HelpText = "Mode for input data (ws or udp for example)")]
        ...
        static void Main(string[] args)
        {
            ...
            CanPacket.Parse("0B6", "00 00 00 77 FF FF FF FF", 50), // taho and speed (1 byte is taho - FF is set, 3 byte is speed - 10 is set)
            ...
            try
            {
                if (_adapter.Connect(Port, Baud, 4))
                {
                    ...
                    Console.WriteLine("Started at ws://127.0.0.1:1212");
        ...
        public static void UpdateCluster(int rpm, int speed, int temp, int gas, bool rturn, bool lturn, bool lbeam, bool hbeam, bool stop, bool esp, float odo, bool oilwarn, bool parking, bool check, bool abs, bool battery, int gear, bool fog, bool gearsport, bool gearauto, bool ignition)
        {
            rpm = Math.Abs(rpm);
